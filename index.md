...
| **Oct 6** | **Sequence Labeling, RNN; LSTM; Attention**;      | [Slides]| [RNN;LSTM](https://web.stanford.edu/~jurafsky/slp3/13.pdf)            | HW9.1 out; <span style="color:#8a0317;font-weight:600"> HW4.1-5.1 due </span>     |      code review4.1-5.1: Team B;         | Talk about final project rules
